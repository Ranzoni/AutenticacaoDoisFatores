...
namespace AutenticacaoDoisFatores.Testes.Compartilhados
{
    ...
    {
        internal static ConstrutorDeCliente RetornarConstrutorDeCliente(Guid? id = null, string? nome = null, string? email = null, string? nomeDominio = null, string? chaveAcesso = null, bool? ativo = null)
        {
            var faker = new Faker();
